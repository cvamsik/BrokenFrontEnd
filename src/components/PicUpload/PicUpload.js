...
class PicUpload extends Component {
  ...
  calculate() {
	...
	if(localStorage.getItem('Q0')=='No'){
	deductionRatio+=0.2}
	if(localStorage.getItem('Q1')=='No'){
	deductionRatio+=0.1}
	if(localStorage.getItem('Q2')=='No'){
	deductionRatio+=0.3}
    ...
    let dummyPrice =localStorage.getItem('price')-Math.round(localStorage.getItem('price') * deductionRatio)
